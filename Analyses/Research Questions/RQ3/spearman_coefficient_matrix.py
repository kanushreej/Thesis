...
spearman_correlation_matrix = data[normalized_columns_of_interest].corr(method='spearman')
...
spearman_correlation_matrix = spearman_correlation_matrix.rename(index=new_names, columns=new_names)

# Display the Spearman correlation matrix using seaborn heatmap
plt.figure(figsize=(8, 6))
sns.heatmap(spearman_correlation_matrix, annot=True, cmap='Spectral', linewidths=0.5, annot_kws={"size": 20})
plt.title('Spearmans Correlation Matrix for US')
...
# Print the Spearman correlation matrix to the console
print("Spearman Correlation Matrix for Normalized Total Posts, Comments, and Activity:")
