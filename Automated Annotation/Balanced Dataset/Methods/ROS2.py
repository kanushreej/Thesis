...
columns_to_balance = ['pro_brexit', 'anti_brexit', 'neutral', 'irrelevant']
...
df_resampled.to_csv('/Users/kanushreejaiswal/Desktop/Thesis/Automated Annotation/Balanced Dataset/UK/ROS/Brexit_ROS2balanced.csv', index=False)
