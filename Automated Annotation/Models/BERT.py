...
# Load Data
labelled_data = pd.read_csv(r"C:\Users\vshap\OneDrive\Desktop\work\code\Thesis\Thesis\Automated Annotation\Training Data\UK\Brexit_training.csv")

# Extract features and targets
X = labelled_data[['text_raw', 'context_raw']].fillna('')
y = labelled_data[['pro_brexit', 'anti_brexit', 'neutral', 'irrelevant']]
