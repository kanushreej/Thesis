...
new_category = capture_create_category_output(lexicon, "Taxation", ["tax"], model="reddit", size=500)

print("New Category Created:", new_category)

# Read the CSV file
input_csv = "/Users/kanushreejaiswal/Desktop/empathmodel/empath/csvfiles/TaxationUS.csv" # Replace with the actual input CSV file path
...
output_csv = "/Users/kanushreejaiswal/Desktop/empathmodel/empath/empath_TaxationUS_keywords.csv"  # Replace with the desired output CSV file path
