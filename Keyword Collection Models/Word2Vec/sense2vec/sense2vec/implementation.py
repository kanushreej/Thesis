...
def get_similar_words(word, s2v, pos_tags, n=500):
    similar_words = set()
    for pos in pos_tags:
        query = word + '|' + pos
        try:
...
similar_words = get_similar_words("Brexit", s2v, pos_tags)

print("Similar Words Retrieved:", similar_words)

# Read the CSV file
input_csv = "/Users/kanushreejaiswal/Desktop/sense2vec/sense2vec/Brexit.csv"  # Ensure this path is correct
...
output_csv = "/Users/kanushreejaiswal/Desktop/sense2vec/sense2vec/top_keywords_s2v.csv"  # Ensure this path is correct
