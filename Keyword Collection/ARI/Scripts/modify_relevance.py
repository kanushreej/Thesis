...
def modify_relevance(issue, moderator, base_dir):
    dir = f"{base_dir}/ARI/Labelled/{issue}_{moderator}.csv"
...
modify_relevance('HealthcareUK', 'Adam', '/Users/adamzulficar/Documents/year3/Bachelor Project/Thesis/Keyword Collection')
