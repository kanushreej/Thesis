...
class LabelingApp:
    ...
    def apply_theme(self):
        ...
        style.configure('.', background=dark_bg, foreground=text_fg, font=('Helvetica', 15))
        style.configure('TLabel', background=dark_bg, foreground=text_fg)
        style.configure('TButton', background=accent_bg, foreground=accent_fg, padding=15, font=('Helvetica', 15, 'bold'))
        style.map('TButton', background=[('active', hover_bg), ('disabled', '#5A5A5A')])
        style.configure('TCheckbutton', background=dark_bg, foreground=text_fg, font=('Helvetica', 15))
    ...
    def setup_text_and_checkbuttons(self):
        ...
        self.text_display = tk.Text(self.text_frame, height=20, width=80, bg='#1E1E1E', fg='#FFFFFF', insertbackground='#FFFFFF', wrap='word', font=('Helvetica', 15))
